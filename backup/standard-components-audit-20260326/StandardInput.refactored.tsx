		...
		const computedStyle = useMemo((): React.CSSProperties => {
			...
			if (disabled) {
				return {
					...
					"--input-border-color": styleTokens.disabledBorder as any,
					"--input-focus-border-color": styleTokens.focusBorder as any,
					"--input-focus-ring-color": styleTokens.focusRing as any,
				};
			}
			...
			if (readOnly) {
				return {
					...
					cursor: "default",
					// CSS Variables para animaciones
					"--input-border-color": styleTokens.readOnlyBorder as any,
					"--input-focus-border-color": styleTokens.focusBorder as any,
					"--input-focus-ring-color": styleTokens.focusRing as any,
				};
			}
			...
			if (error) {
				return {
					...
					// CSS Variables para animaciones
					"--input-border-color": styleTokens.errorBorder as any,
					"--input-focus-border-color": styleTokens.focusBorder as any,
					"--input-focus-ring-color": styleTokens.errorRing as any,
				};
			}
			...
			if (success && !error) {
				return {
					...
					// CSS Variables para animaciones
					"--input-border-color": styleTokens.successBorder as any,
					"--input-focus-border-color": styleTokens.focusBorder as any,
					"--input-focus-ring-color": styleTokens.successRing as any,
				};
			}
			...
			if (isEditing && !error && !success) {
				return {
					...
					// CSS Variables para animaciones
					"--input-border-color": styleTokens.border as any,
					"--input-focus-border-color": styleTokens.focusBorder as any,
					"--input-focus-ring-color": styleTokens.focusRing as any,
				};
			}
