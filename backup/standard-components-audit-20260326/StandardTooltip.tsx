...
import { type TooltipStyleType, type TooltipStyleTokens } from "@/app/providers/DesignTokensProvider";
...
const StandardTooltip = ({
    ...
    const currentStyleTokens: TooltipStyleTokens | null = React.useMemo(() => {
        if (!tokens?.tooltip) return null;
        return tokens.tooltip.styles[colorScheme]?.[styleType] || tokens.tooltip.styles.neutral.solid;
