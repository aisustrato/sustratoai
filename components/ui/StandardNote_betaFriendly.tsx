...
export interface StandardNoteBetaFriendlyProps {
	value?: string;
...
const StandardNoteBetaFriendly = React.forwardRef<HTMLDivElement, StandardNoteBetaFriendlyProps>(
	({ 
		value = "", 
		onChange, 
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
						...
						<div className="flex flex-col h-[400px] max-h-[400px]">
							...
							<textarea
								...
								name={name}
								className={cn(
									"w-full flex-1 rounded-md border px-3 py-3 resize-none overflow-y-scroll",
...
//#region [foo] - 🔚 EXPORTS 🔚
StandardNoteBetaFriendly.displayName = "StandardNoteBetaFriendly";
export { StandardNoteBetaFriendly };
//#endregion ![foo]
