...
import {
	type StandardDatePickerRecipe,
	type DatePickerSizeVariant,
} from "@/lib/theme/components/standard-datepicker-tokens";
...
const StandardDatePicker = React.forwardRef<
	HTMLInputElement,
...
>(
	(
		...
		const datePickerStyles: StandardDatePickerRecipe =
			(tokens.datePicker as any)[colorScheme]?.[size] ||
			(tokens.datePicker as any).primary.md;
