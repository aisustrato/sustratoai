// 📍 components/ui/StandardButton.tsx (v3.2)
// 🎯 PROPÓSITO: Botón estándar del sistema de diseño - componente AGNÓSTICO
// 🔧 DECISIÓN: Consume tokens via generateStandardButtonTokens(), no conoce colores directamente
// ⚠️ F1 FUTURO: Actualmente recalcula tokens en cada render - candidato a tokens precalculados
...
// 💎 CORE: Componente StandardButton - agnóstico a colores
