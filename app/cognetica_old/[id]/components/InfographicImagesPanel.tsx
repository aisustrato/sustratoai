// 📍 app/cognetica_old/[id]/components/InfographicImagesPanel.tsx
...
import {
	...
	InfographicImage,
} from "@/lib/actions/cognetica-old-infographic-images-actions";
	...
	const handleGenerateImages = async () => {
		...
		try {
			...
			const response = await fetch(
				"/api/cognetica_old/generate-infographic-images",
				{
					method: "POST",
					headers: {
