...
// 📍 app/cognetica_old/[id]/ChroniclePanel.tsx
...
// 🔧 DECISIÓN: Client Component que llama a POST /api/cognetica_old/chronicle/[artifactId]
...
export function ChroniclePanel({
  ...
  const handleRunChronicle = async () => {
    ...
    try {
      const res = await fetch(`/api/cognetica_old/chronicle/${artifactId}`, {
        method: "POST",
      });
