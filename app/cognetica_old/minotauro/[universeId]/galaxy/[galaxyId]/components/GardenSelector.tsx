// 📍 app/cognetica_old/minotauro/[universeId]/galaxy/[galaxyId]/components/GardenSelector.tsx
...
export function GardenSelector({
    ...
    const estimateTokens = async () => {
        ...
        try {
            setEstimating(true);
            const response = await fetch('/api/cognetica_old/gardens/estimate-tokens', {
                method: 'POST',
