...
export default function GardenDetailPage() {
    ...
    const handleDeleteGarden = async () => {
        ...
        if (result.success) router.push('/cognetica_old/jardines');
    };
    ...
    if (error || !garden) {
        return (
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <StandardButton onClick={() => router.push('/cognetica_old/jardines')} className="mt-4">← Volver</StandardButton>
            </div>
        );
    }
        ...
        <div className="max-w-6xl mx-auto px-4 py-8 space-y-6">
            ...
            <StandardPageTitle
                ...
                breadcrumbs={[
                    ...
                    { label: "Jardines", href: "/cognetica_old/jardines" },
                    { label: garden.name }
                ]}
                actions={
                    <div className="flex items-center gap-2">
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <button
                                                    ...
                                                    onClick={() => router.push(`/cognetica_old/${artifact.id}`)}
                                                >
                                                    {artifact.title}
                                                </button>
