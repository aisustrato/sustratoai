...
import { updateArtifactTitle } from "@/lib/actions/cognetica-old-actions";
import {
	deleteArtifact,
	canDeleteArtifact,
} from "@/lib/actions/cognetica-old-delete-actions";
			...
			<div className="flex items-start justify-between">
				...
				<div className="flex items-center gap-2">
					...
					<StandardButton
						colorScheme="primary"
						leftIcon={Plus}
						onClick={() => router.push("/cognetica_old/nuevo")}>
						Nuevo Artefacto
					</StandardButton>
				</div>
			</div>
														...
														<div className="flex items-center gap-1.5 group/title">
																...
																<>
																	<h3
																		...
																		onClick={(e: React.MouseEvent) => {
																			e.stopPropagation();
																			router.push(`/cognetica_old/${artifact.id}`);
																		}}>
																		{artifact.title}
																	</h3>
																	<button
															...
															{!editingTitleId && artifact.garden_count > 0 && (
																<button
																	...
																	onClick={(e) => {
																		e.stopPropagation();
																		router.push("/cognetica_old/jardines");
																	}}
