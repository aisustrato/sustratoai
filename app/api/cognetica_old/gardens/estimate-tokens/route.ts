// 📍 app/api/cognetica_old/gardens/estimate-tokens/route.ts
// 🎯 PROPÓSITO: API para estimar tokens de jardines según versión

import { NextRequest, NextResponse } from 'next/server';
import { generateMultipleGardenPayloads, type GardenPayloadVersion } from '@/lib/actions/cognetica-old-gardens-minotauro';
...
export async function POST(req: NextRequest) {
    try {
        ...
        console.error('❌ Error en /api/cognetica_old/gardens/estimate-tokens:', error);
        return NextResponse.json(
