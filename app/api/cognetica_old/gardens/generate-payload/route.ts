// 📍 app/api/cognetica_old/gardens/generate-payload/route.ts
// 🎯 PROPÓSITO: API para generar payload de un jardín según versión

import { NextRequest, NextResponse } from 'next/server';
import { generateGardenPayload, type GardenPayloadVersion } from '@/lib/actions/cognetica-old-gardens-minotauro';
...
export async function POST(req: NextRequest) {
    try {
        ...
        console.error('❌ Error en /api/cognetica_old/gardens/generate-payload:', error);
        return NextResponse.json(
