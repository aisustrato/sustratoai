...
import { deleteCognitiveElements } from '@/lib/actions/cognetica-old-distillation-actions';
import { createSupabaseServerClient } from '@/lib/server';

/**
 * DELETE /api/cognetica_old/cognitive-elements
...
export async function DELETE(req: Request) {
    try {
        ...
        console.error('Error en DELETE /api/cognetica_old/cognitive-elements:', error);
        return NextResponse.json(
