// 📍 app/cognetica/minotauro/[universeId]/galaxy/[galaxyId]/components/GardenArtifactSelector.tsx
...
export function GardenArtifactSelector({
  ...
  const loadGardenArtifacts = async (gardenId: string) => {
    try {
      const response = await fetch('/api/cognetica/gardens/generate-payload', {
        method: 'POST',
