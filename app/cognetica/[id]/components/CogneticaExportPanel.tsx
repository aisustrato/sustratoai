...
export function CogneticaExportPanel({ artifactId, artifactTitle }: CogneticaExportPanelProps) {
    ...
    useEffect(() => {
        const checkCalibration = async () => {
            try {
                const response = await fetch(`/api/cognetica/chat/${artifactId}/sessions`);
                if (response.ok) {
    ...
    const performExport = async (format: ExportFormat) => {
        ...
        try {
            ...
            const response = await fetch(`/api/cognetica/export/${artifactId}/${format}`);
        ...
        <div className="bg-card p-6 rounded-xl border shadow-sm">
            ...
            <div className="space-y-4">
                ...
                <div className="pt-3 border-t text-xs text-muted-foreground space-y-1">
                    ...
                    <p>• Verificable en <code className="text-xs bg-muted px-1 rounded">/api/cognetica/verify-hash?hash=...</code></p>
