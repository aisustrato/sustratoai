/**
 * @file app/cognetica/entidades/conceptos/[concepto_id]/page.tsx
 * Vista raíz de un concepto canónico.
 *
...
interface ConceptoPageProps {
	params: Promise<{ concepto_id: string }>;
...
export default async function ConceptoPage({
	...
	const { concepto_id } = await params;
	...
	// 2. Obtener concepto
	const entidadRes = await obtenerEntidadCanonica("concepto", concepto_id);
	if (!entidadRes.ok) {
		notFound();
	}
