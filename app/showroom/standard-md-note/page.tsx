...
// Fase 2: demo de modo edición con live preview sync.
...
export default function StandardMDNoteShowroomPage() {
  const [mdActual, setMdActual] = useState(MD_PRUEBA);
      ...
      <header className="mb-8 text-center">
        ...
        <StandardText size="base" colorScheme="neutral" colorShade="subtle" className="max-w-2xl mx-auto">
          ...
          <span className="font-medium text-amber-600 dark:text-amber-400">
            Fase 2: modo edición con live preview sync (debounce 300ms).
          </span>
        </StandardText>
      </header>
        ...
        <StandardTabsContent value="info">
          <div className="space-y-4 text-sm">
            ...
            <div className="p-4 border border-amber-200 dark:border-amber-800 rounded-lg bg-amber-50 dark:bg-amber-900/20">
              <StandardText weight="semibold" className="mb-1">Fase 2 — Modo edición</StandardText>
              <StandardText colorScheme="neutral" colorShade="subtle" className="mb-2">
                Botón &quot;Editar&quot; en el header convierte el panel izquierdo en un &lt;textarea&gt; editable.
              ...
              <ul className="list-disc pl-5 space-y-1 text-neutral-600 dark:text-neutral-400">
                <li>Toggle Editar/Vista en header</li>
                <li>Textarea con font-mono y focus ring</li>
                <li>Live preview sync (debounce 300ms)</li>
                <li>Callback onChange para capturar cambios</li>
                <li>Scroll sync adaptado a textarea</li>
              </ul>
            </div>
            ...
            <div className="p-4 border border-purple-200 dark:border-purple-800 rounded-lg bg-purple-50 dark:bg-purple-900/20">
              ...
              <ul className="list-disc pl-5 space-y-1 text-neutral-600 dark:text-neutral-400">
                <li>Click &quot;Editar&quot; → escribe en el textarea → preview se actualiza</li>
