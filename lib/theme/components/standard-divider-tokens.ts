...
export type StandardDividerVariant = "gradient" | "solid" | "subtle";
export type StandardDividerSize = "xs" | "sm" | "md" | "lg" | "xl";

export interface StandardDividerTokens {
 ...
 */
export function generateStandardDividerTokens(
  appColorTokens: AppColorTokens
): StandardDividerTokens {
