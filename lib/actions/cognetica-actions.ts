...
import { extractCognitiveElements } from "./cognetica-extraction-actions";
import { splitPDFIntoPages } from "./cognetica-presentation-actions";
import { ResultadoOperacion } from "./cognetica-filters-actions";
